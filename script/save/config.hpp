...
namespace ikemen::config {

// ── Video ────────────────────────────────────────────────────────────────
constexpr int     RenderMode           = 0;        // 0:SDL2, 1:OpenGL, 2:OpenGL ES, 3:Vulkan
...
constexpr int     CharWinnerPortraitIndex  = 1;
constexpr int     CharLoserPortraitIndex   = 1;
constexpr int     CharOrderPortraitIndex   = 4;
constexpr int     CharVSPortraitIndex      = 1;
constexpr int     CharResultsPortraitIndex = 2;
