...
IKEMEN_NATIVE_STATEBUILDER_LIB   ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_FONT_LIB           ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_VIDEO_LIB          ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_ACTION_LIB         ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_SOUND_RES_LIB      ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_FIGHTING_LIB       ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_BG_LIB             ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_STAGE_LIB          ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_SFF_LIB            ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_COMMAND_LIB        ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_FIGHT_LIB          ?= $(IKEMEN_USE_NATIVE_SSZ)
IKEMEN_NATIVE_CHAR_LIB           ?= $(IKEMEN_USE_NATIVE_SSZ)
...
CXXFLAGS += -DIKEMEN_NATIVE_STATEBUILDER_LIB=$(IKEMEN_NATIVE_STATEBUILDER_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_FONT_LIB=$(IKEMEN_NATIVE_FONT_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_VIDEO_LIB=$(IKEMEN_NATIVE_VIDEO_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_ACTION_LIB=$(IKEMEN_NATIVE_ACTION_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_SOUND_RES_LIB=$(IKEMEN_NATIVE_SOUND_RES_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_FIGHTING_LIB=$(IKEMEN_NATIVE_FIGHTING_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_BG_LIB=$(IKEMEN_NATIVE_BG_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_STAGE_LIB=$(IKEMEN_NATIVE_STAGE_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_SFF_LIB=$(IKEMEN_NATIVE_SFF_LIB)
CXXFLAGS += -DIKEMEN_NATIVE_COMMAND_LIB=$(IKEMEN_NATIVE_COMMAND_LIB)
...
native_manifest:
	...
	@echo "IKEMEN_NATIVE_STATEBUILDER_LIB   = $(IKEMEN_NATIVE_STATEBUILDER_LIB)"
	@echo "IKEMEN_NATIVE_FONT_LIB           = $(IKEMEN_NATIVE_FONT_LIB)"
	@echo "IKEMEN_NATIVE_VIDEO_LIB          = $(IKEMEN_NATIVE_VIDEO_LIB)"
	@echo "IKEMEN_NATIVE_ACTION_LIB         = $(IKEMEN_NATIVE_ACTION_LIB)"
	@echo "IKEMEN_NATIVE_SOUND_RES_LIB      = $(IKEMEN_NATIVE_SOUND_RES_LIB)"
	@echo "IKEMEN_NATIVE_FIGHTING_LIB       = $(IKEMEN_NATIVE_FIGHTING_LIB)"
	@echo "IKEMEN_NATIVE_BG_LIB             = $(IKEMEN_NATIVE_BG_LIB)"
	@echo "IKEMEN_NATIVE_STAGE_LIB          = $(IKEMEN_NATIVE_STAGE_LIB)"
	@echo "IKEMEN_NATIVE_SFF_LIB            = $(IKEMEN_NATIVE_SFF_LIB)"
	@echo "IKEMEN_NATIVE_COMMAND_LIB        = $(IKEMEN_NATIVE_COMMAND_LIB)"
	@echo "IKEMEN_NATIVE_FIGHT_LIB          = $(IKEMEN_NATIVE_FIGHT_LIB)"
